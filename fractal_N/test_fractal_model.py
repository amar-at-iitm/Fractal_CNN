...
# Initialize wandb
wandb.init(
    project="fractal_CNN_cifar10",
    name="fractal-cifar10-test-evaluation",
    config=best_config
)
...
model = CNNModel(
    ...
    alpha1=best_config.get("alpha1", 0.2),
    alpha2=best_config.get("alpha2", 0.2),
...
model_weights_path = SCRIPT_DIR / best_config.get("model_path", "best_model.pth")
...
fig.suptitle("Sample Predictions from Test Set (Fractal CNN)", fontsize=20, y=1.02)
